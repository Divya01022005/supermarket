...
def calculate_total(cart):
    ...
    total_cost = 0
    product_prices = {
        "Apple": 50, "Orange": 40, "Banana": 10, "Watermelon": 100, "Grapes": 50,
        "Potato": 20, "Tomato": 30, "Beans": 15, "Cauliflower": 50, "Onion": 30,
        "Rice": 800, "Oil": 110, "Turmeric": 15, "Mustard": 15, "Honey": 40,
        "Pasta": 60, "Bathroom Cleaner": 90, "Toilet Cleaner": 90, "Biscuits": 30
    }
    items_details = []
...
print(f"Total Cost (before GST and discount): {total_cost:.2f}")
...
def email_sending():
    try:
        ...
        s.sendmail("your_email@gmail.com", receiver_mail, message)
        s.quit()
